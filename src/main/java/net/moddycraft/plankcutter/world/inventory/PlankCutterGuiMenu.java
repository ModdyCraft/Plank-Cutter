...
public class PlankCutterGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PlankCutterGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PlankCutterModMenus.PLANK_CUTTER_GUI, id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PlankCutterMod.PACKET_HANDLER.sendToServer(new PlankCutterGuiSlotMessage(slotid, x, y, z, ctype, meta));
			PlankCutterGuiSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof PlankCutterGuiMenu) {
